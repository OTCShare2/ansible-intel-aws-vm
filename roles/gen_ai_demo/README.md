...
## Usage
Use playbook to run gen_ai_demo role as below
```yaml
---
- name: Run gen_ai_demo role
  hosts: localhost
  tasks:
    - name: Running a role gen ai demo
...
Use below Command:
```commandline
ansible-playbook intel_aws_vm_gen_ai_demo.yml
```
...
| Name                                                                                            | Description                                 | Type     | Default                | Required |
|-------------------------------------------------------------------------------------------------|---------------------------------------------|----------|------------------------|:--------:|
| <a name="input_instance_type"></a> [instance_type](#input_instance_type)                                    | Instance SKU | `string` | `m7i.4xlarge` | no |
| <a name="input_availability_zone"></a> [availability_zone](#input_availability_zone_name)                                           | AZ to start the instance in                 | `string`    | `us-east-2c`                    | no |
| <a name="input_volume_size"></a> [volume_size](#input_volume_size)                                           | Storage size                                | `int`    | `100`                     | no |
...
```yaml
subnet_id: "<subnet-xxxxxxxxxxxxxxx>" # As default value
```

roles/gen_ai_demo/tasks/ec2_vm.yml
```yaml
